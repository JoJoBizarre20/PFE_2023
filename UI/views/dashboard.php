            ...
            <tbody>
                <?php foreach ($UserData["assignments"] as $assignment) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            <a class='dropdown-trigger btn' href='#' data-target='dropdown<?= $assignment["Id"] ?>'>Mark As</a>
                            <!-- Dropdown Structure -->
                            <ul id='dropdown<?= $assignment["Id"] ?>' class='dropdown-content' style="width:100% !important;">
